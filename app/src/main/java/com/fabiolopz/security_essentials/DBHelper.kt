...
class DBHelper(context: Context, factory: SQLiteDatabase.CursorFactory?) :
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        db?.execSQL("CREATE TABLE $TABLE_NAME ($COLUMN_ID INTEGER PRIMARY KEY, $COLUMN_NAME TEXT, $COLUMN_EMAIL TEXT, $COLUMN_UUID TEXT)")
    }
    ...
    fun insertRow(name: String, email: String, uuid: String){
